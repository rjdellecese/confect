...
/**
 * A Confect client which uses a WebSocket to communicate with your Convex backend and supports reactive query subscriptions. Wraps [ConvexClient](https://docs.convex.dev/api/classes/browser.ConvexClient).
 */
export const ConfectClient = Context.GenericTag<ReturnType<typeof make>>(
...
export const layer = (
  address: string,
  options?: ConstructorParameters<typeof ConvexClient>[1],
) => Layer.sync(ConfectClient, () => make(address, options));
