import type { DataModel } from "@rjdellecese/confect";
import {
...
export const StorageActionWriter =
  Storage.StorageActionWriter;
export type StorageActionWriter =
  typeof StorageActionWriter.Identifier;
...
export const MutationRunner =
  MutationRunner_.MutationRunner;
...
export const QueryCtx =
  QueryCtx_.QueryCtx<
    DataModel.DataModel.ToConvex<
      DataModel.DataModel.FromSchema<
        typeof schemaDefinition
      >
    >
  >();
