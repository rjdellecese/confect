...
import * as Internal from "./internal/AiGatewayClient";
...
> = Internal.make.pipe(Effect.provide(AiGatewayServiceToken.layer));
...
export const layer: Layer.Layer<AiGatewayClient, never, HttpClient.HttpClient> =
  Internal.layer.pipe(Layer.provide(AiGatewayServiceToken.layer));
