...
```bash pnpm
pnpm add convex @gunta/confect-core @gunta/confect-server @gunta/confect-cli @gunta/confect-react
```

```bash npm
npm install convex @gunta/confect-core @gunta/confect-server @gunta/confect-cli @gunta/confect-react
```

```bash yarn
yarn add convex @gunta/confect-core @gunta/confect-server @gunta/confect-cli @gunta/confect-react
```

```bash bun
bun add convex @gunta/confect-core @gunta/confect-server @gunta/confect-cli @gunta/confect-react
```
