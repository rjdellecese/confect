...
const layout = QueryStreamKeyLayout.fromIndex(["authorId", "_creationTime"]);
...
const innerLayout = QueryStreamKeyLayout.fromIndex(
  ["noteId", "_creationTime"],
  1,
);
