...
describe("IsRecord", () => {
  describe("true for Record types", () => {
    test("Record<string, number>", () => {
      expectTypeOf<IsRecord<Record<string, number>>>().toEqualTypeOf<true>();
    });

    test("Record<string, string>", () => {
      expectTypeOf<IsRecord<Record<string, string>>>().toEqualTypeOf<true>();
    });

    test("Record<string, boolean>", () => {
      expectTypeOf<IsRecord<Record<string, boolean>>>().toEqualTypeOf<true>();
    });
    ...
    test("Record<string, never>", () => {
      expectTypeOf<IsRecord<Record<string, never>>>().toEqualTypeOf<true>();
    });

    test("Record<string, { foo: string }>", () => {
      expectTypeOf<
        IsRecord<Record<string, { foo: string }>>
      >().toEqualTypeOf<true>();
    });

    test("Record<string, string | number>", () => {
      expectTypeOf<
        IsRecord<Record<string, string | number>>
      >().toEqualTypeOf<true>();
    });

    test("ReadonlyRecord<string, number>", () => {
      expectTypeOf<
        IsRecord<ReadonlyRecord<string, number>>
      >().toEqualTypeOf<true>();
    });
  });
  ...
  describe("false for Object types", () => {
    test("{ foo: string }", () => {
      expectTypeOf<IsRecord<{ foo: string }>>().toEqualTypeOf<false>();
    });

    test("{ foo: string; bar: number }", () => {
      expectTypeOf<
        IsRecord<{ foo: string; bar: number }>
      >().toEqualTypeOf<false>();
    });

    test("{ readonly foo: string }", () => {
      expectTypeOf<IsRecord<{ readonly foo: string }>>().toEqualTypeOf<false>();
    });
    ...
    test("{ [key: string]: string; foo: string }", () => {
      expectTypeOf<
        IsRecord<{ [key: string]: string; foo: string }>
      >().toEqualTypeOf<false>();
    });

    test("nested object", () => {
      expectTypeOf<IsRecord<{ foo: { bar: string } }>>().toEqualTypeOf<false>();
    });
  });
  ...
  describe("false for non-object types", () => {
    ...
    test("any", () => {
      expectTypeOf<IsRecord<any>>().toEqualTypeOf<false>();
    });

    test("unknown", () => {
      expectTypeOf<IsRecord<unknown>>().toEqualTypeOf<false>();
    });
    ...
    test("Array<number>", () => {
      expectTypeOf<IsRecord<Array<number>>>().toEqualTypeOf<false>();
    });

    test("Map<string, number>", () => {
      expectTypeOf<IsRecord<Map<string, number>>>().toEqualTypeOf<false>();
    });

    test("Set<string>", () => {
      expectTypeOf<IsRecord<Set<string>>>().toEqualTypeOf<false>();
    });
  ...
  describe("edge cases", () => {
    test("empty object {}", () => {
      expectTypeOf<IsRecord<{}>>().toEqualTypeOf<false>();
    });
    ...
    test("Record with non-string keys should be false", () => {
      expectTypeOf<IsRecord<Record<number, string>>>().toEqualTypeOf<false>();
    });
  });
});
