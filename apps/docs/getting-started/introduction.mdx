...
<Note>
  This documentation targets **Effect 4** (`4.0.0-beta.67`) and
  **Convex 1.39+**. The packages are published to the `effect4`
  dist-tag while Effect 4 is in beta. If you're still on Effect 3, see
  the [stable v7
  branch](https://github.com/rjdellecese/confect/tree/main) for the
  previous docs.
</Note>
