...
Write inputs are typed under each table's named document type (e.g. `NotesDoc`, minus the system fields). See [Document types](/server/database/schema#document-types).
